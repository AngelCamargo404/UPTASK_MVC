// IIFE - INMEDIATELY INVOCE FUNCTION EXPRESION
(function () {
    ...
    function mostrarFormulario(editar = false, tarea = {}) {
        ...
        modal.innerHTML = `
            <form class="formulario nueva-tarea">
                ...
                <div class="campo">
                    <label>Tarea</label>
                    <input type="text" name="tarea" placeholder="${tarea.nombre ? 'Edita la Tarea' : 'Añadir la Tarea al Proyecto Actual'}" id="tarea" value="${tarea.nombre ? tarea.nombre : ''}"></input>
                </div>
                <div class="opciones">
    ...
    function mostrarAlerta(mensaje, tipo, referencia) {
        ...
        //referencia.parentElement, referencia.nextElementSibling.
        ...
        try {
            ...
            const printAlerta = () => {
                resultado.then((datos) => {
                    if(datos.mensaje && datos.tipo){
                    // Mostrar una alerta de error o exito
                    mostrarAlerta(datos.mensaje, datos.tipo, document.querySelector('.formulario legend'));
    ...
    async function actualizarTarea(tarea) {
        ...
        try {
            url = "http://127.0.0.1:3000/api/tarea/actualizar";
    ...
    function limpiarTareas() {
        const listadoTareas = document.querySelector('#listado-tareas');
        // listadoTareas.innerHTML = ''; // UNA FORMA DE LIMPIAR LAS TAREAS MAS LENTA
